                      ...
                      <div className="col-12">
                        <div className="box">
                          <div className="box-info-messager">
                            <div className="box-body pd-0 d-flex align-items-start">
                              <div className="left w-90">
                                <div className="message-pic big">
                                  <img
                                    src="./images/avatar/avt-mess.png"
                                    alt=""
                                  />
                                ...
                                <div className="content">
                                  <div className="username">
                                    <h5 className="fs-24">Randy Riley</h5>
                                  </div>
                                  <div className="text">
                                    <p className="pb-5 mt-9 mb-0">
                                      Lead UX/UI Designer
                                    </p>
                                  </div>
                                  <div className="checkbox">
                                    <input
                                      ...
                                      defaultChecked=""
                                    />
                                    <span className="ml-10">Active</span>
                                  </div>
                                </div>
                              </div>
                              <div className="right">
                                <div className="dropdown ml-14">
                                  <a
                                    ...
                                    aria-expanded="false"
                                  >
                                    <i className="bx bx-cog color-text" />
                                  </a>
