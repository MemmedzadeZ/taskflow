                      ...
                      <div className="box-body d-flex pb-0">
                        <div className="me-auto">
                          ...
                          <p className="fs-14 mb-0 mt-11">
                            <span className="text-primary">-3% </span>than last
                            month
                          </p>
                        </div>
                        ...
                        <div className="row">
                          <div className="col-6 col-xl-12 w-sm-100 mb-0">
                            <ul className="box-list mt-26 pr-67">
                              ...
                              <li>
                                <span className="bg-success square"></span>UX/UI
                                Design
                                <span>18%</span>
                              </li>
                              <li>
                              ...
                              <li>
                                <span className="bg-success square"></span>Brand
                                Identity
                                <span>12.50%</span>
                              </li>
                              <li>
